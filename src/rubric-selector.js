...
const RUBRIC_KEY = 'r17:rubricId';

function activeId() {
  const value = window.localStorage.getItem(RUBRIC_KEY);
  return value === 'calificacion-estandar' ? value : 'santo-domingo-regional';
}
...
function install() {
  ...
  select.addEventListener('change', () => {
    window.localStorage.setItem(RUBRIC_KEY, select.value);
